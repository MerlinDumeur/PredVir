...
# Pr.load_files(keep_XpG=keep_XpG,rename_XpG=rename_XpG,dropna_XpG=dropna_XpG,transpose_Trscr=True,keep_Plt=keep_Plt,rename_Plt=rename_Plt,dtype_Plt=dtype_Plt,remove_ctrl_Plt=False,use_plt=False)

# # nmlist = [None,6,12,60]
# nmlist = [12,30,60]

# Pr.generate_XY(nmonths_list=nmlist,standardize=False,dataformat='TCGA',var_type='DFS')
...
LogR1GS_iterative = GeneSelection.GeneSelector_GLM_Iterative(LogR1_m,1200)
