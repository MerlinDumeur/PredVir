...
rename_XpG = {"id":Constants.ID,"Characteristics..age.":Constants.AGE,"Comment..histology.":Constants.HISTOLOGY,'os':Constants.OS,'dead':Constants.DEAD}
keep_XpG = ['id','Characteristics..age.','Comment..histology.','os','dead']
dropna_XpG = [Constants.HISTOLOGY,Constants.OS]

keep_Plt = ['Unnamed: 0']
rename_Plt = {'Unnamed: 0':Constants.ID}
# dtype_Plt = {'SPOT_ID':str}

Pr.load_files(keep_XpG=keep_XpG,rename_XpG=rename_XpG,dropna_XpG=dropna_XpG,transpose_Trscr=True,keep_Plt=keep_Plt,rename_Plt=rename_Plt,dtype_Plt={},remove_ctrl_Plt=False,use_plt=False)

nmlist = [6,12,30,60]

Pr.generate_XY(nmonths_list=nmlist,standardize=False,dataformat='epilung')

Pr.generate_OS(nmlist,use_dfs=False)
