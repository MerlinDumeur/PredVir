...
#     X1 = pd.read_pickle(f'LUSC/{n}/X.pkl')
#     X2 = pd.read_pickle(f'LUAD/{n}/X.pkl')
#     X3 = X1.append(X2)
#     print(X1.shape)
#     X3.to_pickle(f'ADSC/{n}/X.pkl')
                            
#     Y1 = pd.read_pickle(f'LUSC/{n}/Y.pkl')
#     Y2 = pd.read_pickle(f'LUAD/{n}/Y.pkl')
#     Y3 = Y1.append(Y2)
#     Y3[X3.index].to_pickle(f'ADSC/{n}/Y.pkl')

#     OS1 = pd.read_pickle(f'LUSC/{n}/OS.pkl')
#     OS2 = pd.read_pickle(f'LUAD/{n}/OS.pkl')
#     OS = OS1.append(OS2)
#     OS.to_pickle(f'ADSC/{n}/OS.pkl')
    
#     DFS1 = pd.read_pickle(f'LUSC/{n}/DFS.pkl')
#     DFS2 = pd.read_pickle(f'LUAD/{n}/DFS.pkl')
#     DFS = DFS1.append(DFS2)
#     DFS.to_pickle(f'ADSC/{n}/DFS.pkl')

#     Undead1 = pd.read_pickle(f'LUSC/{n}/Undead.pkl')
#     Undead2 = pd.read_pickle(f'LUAD/{n}/Undead.pkl')
#     Undead = Undead1.append(Undead2)
#     Undead.to_pickle(f'ADSC/{n}/Undead.pkl')
...
LogR1GS_iterative = GeneSelection.GeneSelector_GLM_Iterative(LogR1_m,1000)
...
KLR_RBF_Gdict = np.logspace(-6,-3.5,15)
KLR_RBF_Cdict = np.logspace(0,1,10)
...
XGB_maxdepth = [2,3]
XGB_lr = np.logspace(-5,-3,3)
XGB_nestimators = [100,150,200]
XGB_alpha = [0]
XGB_beta = [0]
...
gs_list = [GS]
# models_list = [RF_CV]
models_list = [LR2_CV,KLR2_SIG_CV,KLR2_RBF_CV,RF_CV,XGB_CV]
